...
contract DistributionSInterest {
  ...
  // S dsec https://etherscan.io/token/0x372Bc201134676c846F1fd07a2a059Fd18526De3
  address _lp_token_address = 0x372Bc201134676c846F1fd07a2a059Fd18526De3;
  ...
  function redeem(address lp_token_address, uint256 amount) public {
    ...
    SFI.transfer(msg.sender, amount.mul(1 ether).div(lp_token.totalSupply()).mul(S_INTEREST_EARNED).div(1 ether));
  }
