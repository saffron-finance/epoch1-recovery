...
./node_modules/.bin/ganache-cli -f "https://mainnet.infura.io/v3/$project_id" -m "$mnemonic"  --port 8545 --gasLimit 0xffffffffff --allowUnlimitedContractSize -u "0x09e9ff67d9d5a25fa465db6f0bede5560581f8cb" - > /dev/null & ganache_pid=$!
